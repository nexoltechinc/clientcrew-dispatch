...
export const currentUser: User = {
  id: 'user-1',
  email: 'nexoltechsolutionsinc@gmail.com',
  name: 'Alex Morgan',
  role: 'admin',
...
export const jobs: Job[] = [
  {
    ...
    accountingInvoiceId: 'ACC-INV-12345',
    accountingInvoiceUrl: '/admin/invoices/ACC-INV-12345',
...
export const auditEvents: AuditEvent[] = [
  ...
  },
  {
    ...
    actorType: 'SYSTEM',
    summary: 'Accounting invoice task created',
  ...
  },
  {
    ...
    summary: 'Invoice created in accounting system',
    payload: { accountingInvoiceId: 'ACC-INV-12345' },
  ...
  },
  {
    ...
    actorType: 'MAKE_WORKER',
    summary: 'Invoice creation failed - accounting connection timeout',
...
export const systemAlerts: SystemAlert[] = [
  ...
  },
  {
    id: 'alert-2',
    type: 'ERROR',
    title: 'Accounting Connection Issue',
    message: 'Failed to connect to accounting API - retrying',
    dismissible: true,
    dismissed: false,
